...
const Intro = ({ scrollId }) => {
    ...
    const handlePrevImage = () => {
        setProductIndex((prevIndex) => (prevIndex - 1 + Ivy_Two[productColor].length) % Ivy_Two[productColor].length
        );
    };
        ...
        <>
            <div className='flex relative' >
                <main className='bg-[#f0f0f0] w-[60vw] h-[92vh] flex px-3 relative ' >
                    ...
                    <img src={Ivy_Two[productColor][productIndex]} alt="Product Image" className=" w-[100%] h-[100%] object-cover transition-all ease-out duration-500 " loading='lazy' />
                ...
                <aside className='mx-8 w-[36vw]'>
                    ...
                    <div className="flex gap-6 my-8">
                        ...
                        <button onClick={() => setProductColor("Pebble Grey")} style={{ background: 'linear-gradient(-45deg, #efe1cb 49%, #f4f1ec 51%)' }} className={`h-6 w-6 rounded-full ring-offset-white ring-offset-4 ring-1 hover:ring-gray-400 ${productColor == "Pebble Grey" ? "ring-black" : "ring-white"}`}></button>
                    </div>
                    <hr />
                    ...
                    <p className='underline underline-offset-4 decoration-1	mt-5 flex items-end relative'>
                        ...
                        <button onClick={handleOpenModal} >
                            <img className='absolute border-b border-black pb-0.5 w-[50px] top-[3px] ' src="/Common/Klarna.png" alt="Klarna Modal" loading='lazy' />
                        </button>
                    </p>
