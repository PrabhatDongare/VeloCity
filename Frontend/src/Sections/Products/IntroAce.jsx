...
const IntroAce = ({ scrollId }) => {
    ...
    const updateProductAtFrontend = async () => {
        await dispatch(fetchProductData({ "product_id": 1 }))
    }
        ...
        <>
            <div className='flex relative' >
                ...
                <aside className='mx-8 w-[36vw]'>
                    ...
                    <button onClick={handleAddToCart} className='bg-black text-white w-full rounded-full py-4 text-xs font-montserrat-medium my-6 hover:bg-white hover:text-black border border-[#727373]' > Add to Cart </button>
                    <hr />
