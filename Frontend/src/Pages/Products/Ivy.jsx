...
const Intro = React.lazy(() => import('../../Sections/Products/Ivy/Intro'));
  ...
  return (
    <>
      ...
      <Suspense fallback={<div className='text-center'>Loading...</div>}>
        <Intro scrollId={"ivy-specifications"} />
      </Suspense>
      ...
      <section className='flex'>
        ...
        <div className='px-36 my-auto'>
          ...
          <p className=' font-montserrat-regular'>The Shimano® discbrakes are premium hydraulic disc brakes designed to deliver lightning-fast stopping power, so you can ride with complete confidence and control. Rest assured, you'll feel the difference in the moments you need it most.</p>
        </div>
      </section>
      <hr />

      {/* Product Specification */}
      <section id="ivy-specifications" className='ml-14 mr-28 text-[#727373] my-24 '>
        ...
        <div className='grid grid-flow-col gap-28 font-montserrat-medium my-16' >
          <div className=' grid grid-flow-row gap-5'>
            ...
            <div >
              ...
              <p className=' font-montserrat-regular'>164-184cm</p>
            </div>
