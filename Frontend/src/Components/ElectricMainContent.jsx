  ...
  return (
    <>
      ...
      <section className='relative mt-16'>
        ...
        {/* <div className='text-[#c6c5c5] absolute top-48 left-32 w-2/6' >
      ...
      {productName == "Ace_Two" ?
        <section className='flex'>
          <div className='mx-32 my-auto'>
            ...
            <p className='text-[#5b5b5b] font-montserrat-light'>Introducing the Ivy Two, the electric bike that takes your daily commute to the next level. With an accessible lower frame, the latest technology, and safety features, the Ivy delivers instant power, convenience, and peace of mind at every turn, making it the go-to bike for any commute. Equipped with a bright LED brake light for enhanced visibility and safety tracking for added security, the Ivy Two is the perfect combination of design, technology, and safety.</p>
          </div>
      ...
      <section className='flex'>
        <div className='w-1/2'>
          ...
          <img className='' src="/images/Ace/E-Leasing_desktop.webp" alt="Ivy Two PDP" loading='lazy' />
        </div>

        <div className='my-auto w-1/2 px-40'>
          <h1 className='text-5xl font-montserrat-medium py-5'>Silent and powerful mid-motor</h1>
          <p className='text-[#5b5b5b] font-montserrat-light'>Natural and powerful. The 65Nm torque mid-engine gives you all the power you need. Because the engine is directly connected to your pedals, it automatically adjusts its power to your torque instead of speed. This gives you the most natural electric biking experience there is.</p>
        </div>
      </section>
      ...
      <section className='flex'>
        <img className='w-1/2 ' src="/images/Employees/Leasing_form_desktop_mobile.webp" alt="Ivy Two PDP" loading='lazy' />
        <div className='px-40 my-auto'>
      ...
      <section className='flex'>
        ...
        <div className='w-1/2 my-28 px-14'>
          <img src="/Common/Homepage_desktop_mobile_2.webp" alt="" />
          {/* <Suspense fallback={<LoadingAnimation/>}>
            <CustomVideo videoDimension={"h-[100vh] w-full"} videoButton={"flex items-center justify-center text-9xl h-[100vh] w-full "}
      ...
      <section className='flex'>
        <img className='w-1/2 mb-20 px-14' src="/images/Ivy/Shimano___hydraulic_discbrakes_desktop.webp" alt="Ivy Two PDP" loading='lazy' />
